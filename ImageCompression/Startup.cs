...
using ImageCompression.Service.Concrete;
using ImageCompression.Infrastructure;
using ImageCompression.Helpers;
using ImageCompression.Infrastructure.Mappers;
...
namespace ImageCompression
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                x.AddProfile(new ImageVmDTOMapper());
            });
            //Services
